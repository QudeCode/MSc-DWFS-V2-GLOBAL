...
| GET               | /restaurants                                          | location, type, open |                                                                         | `{ "restaurants": [{ "restaurant-id": 1, "name": "Can Mauri", "location": "Sabadell", "type": "mediterranian", "open": true }, ...] }` | 200 Ok <br/>400 Not Found                           |
...
CORRECCIÓN:
- Está más o menos bien, pero falla una parte de semántica. Para la gestion del lado del restaurante, los endpoints deberían ser: "/restaurants/..." y del lado de los usuarios: "/users/..."
  - Eso implica la creación de un endpoint POST de /restaurants y /users
- En la solución, se diferencia entre "menu" y "dishes"
- Ejemplo claro:
