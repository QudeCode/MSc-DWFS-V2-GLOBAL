...
|-------------|--------------------------------------|----------------------|-------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| GET         | /spaces                              | location, date, type |                                                                   | `{ "spaces": [{ "space-id": 1, "location": "Sabadell", "type": "auditory", "capacity": 100, "bookings": [{ "booking-id": 1, "start": "01/01/2026-10:00", "end": "01/01/2026-18:00" }, ...] }] }` | 201 Created <br/>400 Bad Request                    |
| POST        | /users/{userId}/bookings             |                      | `{ "start": "01/01/2026-10:00", "end": "01/01/2026-18:00" }`      | `{ "space-id": 1, "booking-id": 1, "start": "01/01/2026-10:00", "end": "01/01/2026-18:00" }`                                                                                                     | 201 Created <br/>400 Bad Request <br/>404 Not Found |
| DELETE      | /users/{userId}/bookings/{bookingId} |                      |                                                                   | `{ "message": "Reservation deleted succesfully." }`                                                                                                                                              | 200 Ok <br/>404 Not Found                           |
| PATCH       | /users/{userId}/bookings/{bookingId} |                      | `{ "start": "01/01/2026-11:00" }`                                 | `{ "space-id": 1, "booking-id": 1, "start": "01/01/2026-11:00", "end": "01/01/2026-18:00" }`                                                                                                     | 200 Ok <br/>400 Bad Request <br/>404 Not Found      |
| POST        | /spaces                              |                      | `{ "location": "Sabadell", "type": "auditory", "capacity": 100 }` | `{ "space-id": 1, "location": "Sabadell", "type": "auditory", "bookings": [] }`                                                                                                                  | 201 Created <br/>400 Bad Request                    |
...
- En la corrección, en vez de "/spaces/{spaceId}/events", usan directamente "/events".