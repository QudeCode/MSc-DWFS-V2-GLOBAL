...
| GET         | /games/{gameId}                                   |              |                                                                                      | `{ "game-id": 1, "time-start": "10/01/01 - 10:00", "time-end": "10/01/01 - 11:00", "winner": 1, "boats": [{}, ...], "shots": [{}, ...] }`       | 200 Ok <br/>404 Not Found                           |
...
| POST        | /games/{gameId}/players/{playerId}/shots          |              | `{ "coords: [5,3] }`                                                                 | `{ "game-id": 1, "player": 1, "shot-id": 1, "hit": true, "coord-origin-x": 5, "coord-origin-y": 3 }`                                            | 201 Created <br/>404 Not Found <br/>400 Bad Request |
...
Corrección:
- En la solución, los usuarios no van atados a una partida, se pueden "registrar" independientemente
- Se crea un unico endpoint "/games/{gameId}/shots" para los disparos, y en el body se determina la dirección del disparo
- En los barcos, se mandan todas las coordenadas ocupadas, en vez de lo que yo he hecho
- Se envian las coordenadas como array de 2 elementos
- En el get del game, no permite query params, lo cual tiene sentido