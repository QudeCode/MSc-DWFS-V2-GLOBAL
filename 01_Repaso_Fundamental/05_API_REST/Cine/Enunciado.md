...
| POST        | /users/{userId}/bookings/{roomId} |              | `{ "booking-id": 1, "user-id": 1, "room-id": 1, "film-id": 1 }`                           |                                                                                    | 201 Created <br/>400 Bad Request                    |
| DELETE      | /users/{userId}/bookings/{roomId} |              |                                                                                           | `{ "message": "Booking deleted succesfully" }`                                     | 200 Ok <br/>404 Not Found                           |
| PATCH       | /users/{userId}/bookings/{roomId} |              | `{ "film-id": 3 }`                                                                        | `{ "booking-id": 1, "user-id": 1, "room-id": 1, "film-id": 3 }`                    | 200 Ok <br/>404 Not Found <br/>400 Bad Request      |
| POST        | /bookings/{booking_id}/payments   |              | `{ "import": 9.90, "payment-method": "VISA" }`                                            | `{ "booking-id": 1, "import": 9.90, "payment-method": "VISA" }`                    | 201 Created <br/>404 Not Found <br/>400 Bad Request |
