...
|-------------|------------------|---------------|-------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|
| GET         | /books           | title, author |                                                                               | `{ "book_id": 1, "title": "Wow, la peli", "author": "Arthur M., "available": true }`                                                                                     | 200 Ok <br/>400 Bad Request        |
| POST        | /loans           |               | `{ "book_id": 1, "user_id": 1, "loan_date": "01/01/2026" }`                   | `{ "loan_id": 1, book_id": 1, "user_id": 1, "loan_date": "01/01/2026", "loan_active": true }`                                                                            | 201 Created <br/>400 Bad Request   |
| PATCH       | /loans           |               | `{ "book_id": 1, "user_id": 1, "loan_id": 1, "loan_end_date": "01/02/2026" }` | `{ "loan_id": 1, book_id": 1, "user_id": 1, "loan_date": "01/01/2026", "loan_end_date": "01/02/2026", "loan_active": false }`                                            | 200 Ok <br/>404 Not Found          |
| GET         | /loans/{userId}  |               |                                                                               | `[{ "loan_id": 1, book_id": 1, "title": "Wow, la peli", "author": "Arthur M.", "loan_date": "01/01/2026", "loan_end_date": "01/02/2026", "loan_active": false }, ... ]`  | 200 Ok <br/>404 Not Found          |
| PATCH       | /books/{bookId}  |               | `{ "title": "Paco, la peli", "author": "Arthur P., "year_relese": 2025 }`     |                                                                                                                                                                          | 200 Ok <br/>404 Not Found          |
| POST        | /report/{userId} |               |                                                                               | `[{ "book_id": 1, "title": "Wow, la peli", "author": "Arthur M." }, ... ]`                                                                                               | 201 Created <br/>404 Not Found     |
